            ...
            <div class="col-6 mx-auto">
                ...
                %>
                    <form>
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <input type="text" class="form-control" name="film_name" placeholder="Name" readonly value="<% out.print(film.getName()); %>">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <textarea class="form-control" name="film_description" placeholder="Description" readonly><% out.print(film.getDescription()); %></textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
