...
<body>
<%@include file="../task_views/navbarForTask.jsp"%>
            ...
            <div class="col-9">
                <div class="row">
                    ...
                    <div class="card ml-2 mb-2" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><%=tasks1.getName()%></h5>
                            <p class="card-text">
                                Name of Task <b><%=tasks1.getName()%> KZT</b> <br>
                                Done or Not : <%=tasks1.getDescription()%> <br>
                                Time : <%=tasks1.getDeadlineDate()%>
                            </p>
                            <a href="/taskDetails?id=<%=tasks1.getId()%>" class="btn btn-primary">Details</a>
                        </div>
                    </div>
