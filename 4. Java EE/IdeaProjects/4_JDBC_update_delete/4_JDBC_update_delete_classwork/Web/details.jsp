                            ...
                            <form action="/savefilm" method="post">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                <select class="form-select" name="film_genre">
                                                    ...
                                                    <option <% if (film.getGenre().equals("tragedy")) out.print("selected");%> >tragedy</option>
                                                    <option <% if (film.getGenre().equals("fantasy")) out.print("selected");%> >fantasy</option>
                                                    <option <% if (film.getGenre().equals("documentary")) out.print("selected");%> >documentary</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                <input type="text" class="form-control" name="film-rating" value="<% out.print(film.getRating()); %>">
                                            </div>
                                        </div>
                                    </div>
